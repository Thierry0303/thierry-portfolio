# 📋 App.jsx Content for Mobile

**Copy this entire code and paste it into GitHub**
...
export default function ThierryPortfolio() {
  ...
  const projects = [
    {
      ...
      description: 'Comprehensive directory of London schools with advanced filtering, admissions data, and school performance metrics.',
    ...
    },
    {
      ...
      description: 'NHS GP surgery finder with location-based search and appointment booking information.',
      link: 'https://londongp.directory',
      highlights: ['NHS Data', 'Location Search', 'Healthcare Services'],
      color: 'from-green-600 to-green-400'
    },
    {
      title: 'Card Payment Dev Docs',
      description: 'Developer documentation for payment systems covering ISO 8583, EMV standards, and PCI DSS.',
      link: 'https://thierry0303.github.io/paydev-docs/',
      highlights: ['Payment Standards', 'Technical Depth', 'Developer-Focused'],
  ...
  const achievements = [
    {
      ...
      description: '13+ years in payment technology, leading complex EMEA projects with Tier 1 institutions.',
      icon: Award,
      color: 'bg-amber-500/20 text-amber-300'
    },
    {
      title: 'Full-Stack Builder',
      description: 'From Python pipelines to React frontends. Entrepreneur with multiple live products.',
      icon: Code2,
      color: 'bg-blue-500/20 text-blue-300'
    },
    {
      title: 'Academic Rigor',
      description: 'MSc Birkbeck, published research on blockchain adoption in payment systems.',
      icon: BookOpen,
      color: 'bg-purple-500/20 text-purple-300'
    },
    {
      title: 'Multilingual',
      description: 'Native French & Portuguese, fluent English & Spanish.',
      icon: Zap,
  ...
  const skills = [
    { category: 'Payment Systems', skills: ['ISO 8583', 'EMV', 'NFC', '3DS 2.0', 'PCI DSS', 'Tokenization'] },
    { category: 'Technical Leadership', skills: ['Project Management', 'Team Leadership', 'Agile', 'Cross-functional'] },
    { category: 'Frontend', skills: ['React', 'Tailwind CSS', 'JavaScript', 'Responsive Design'] },
    { category: 'Backend', skills: ['Python', 'Data Pipelines', 'GitHub Actions', 'Automation'] }
  ];
  ...
  const experiences = [
    {
      ...
      focus: '3DS Fraud Prevention Solutions',
      highlights: [
    ...
    },
    {
      ...
      focus: 'Global Acquirer Onboarding',
      highlights: [
  ...
  const academic = [
    {
      ...
      year: '2016–2018',
      details: 'Dissertation on blockchain adoption in digital payments.',
      highlights: ['Innovation Theory', 'PSD2/GDPR', 'Industry Research']
    },
    {
      title: 'BA Management + Languages',
      institution: 'Portugal',
      year: '2005–2010',
      details: 'Business and language studies with Erasmus exchange.',
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-gray-100 overflow-x-hidden">
      ...
      <section className="relative min-h-screen pt-20 flex items-center justify-center px-6 overflow-hidden">
        ...
        >
          ...
          >
            13+ years delivering complex, high-impact international payment solutions across Europe. Multilingual specialist in card payments, fraud prevention, and fintech innovation.
          </motion.p>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white hover:text-blue-300">LinkedIn Profile</h3>
              <p className="text-gray-400 mt-2">Connect with me on LinkedIn</p>
            </motion.a>
            ...
            >
              ...
              <p className="text-gray-400 mt-2">View my projects and contributions</p>
            </motion.a>
          </div>
...
**That's it! Copy the entire code above and paste into GitHub.**
